 ...
 * before using this!
 */
public final class NPAnalyticsTrackers {
    private static NPAnalyticsTrackers sInstance;
     ...
     */
    private NPAnalyticsTrackers(Context context) {
    ...
    public static synchronized void initialize(Context context) {
        ...
        sInstance = new NPAnalyticsTrackers(context);
    }

    public static synchronized NPAnalyticsTrackers getInstance() {
        if (sInstance == null) {
